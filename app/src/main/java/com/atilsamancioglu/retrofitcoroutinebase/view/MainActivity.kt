...
class MainActivity : AppCompatActivity(), RecyclerViewAdapter.Listener {
    ...
    val excetionHandler = CoroutineExceptionHandler { coroutineContext, throwable ->
    ...
    private fun loadData() {
        ...
        job = CoroutineScope(Dispatchers.IO).launch {
            ...
            //işlemi maine getirdik
            //+excetionHandler hata olduğunda bilgi ericek diye koyduk
            withContext(Dispatchers.Main+excetionHandler) {
